...
def cellpose_train(directory):
    ...
    io.logger_setup()
    images, labels, image_names, test_images, test_labels, image_names_test = io.load_train_test_data(directory / 'train', directory / 'validate', image_filter='im', mask_filter='mask')
    ...
    model_path, train_losses, test_losses = train.train_seg(model.net,
                                                            ...
                                                            n_epochs=100, save_path=directory, model_name='model')
    losses_dict = {'Train Losses': train_losses, 'Validation Losses': test_losses}
    with open(directory / 'losses.txt') as f:
