...
def main():
    show_frame(Path('ims_for_report/phase/images/im_1.jpg'), Path('ims_for_report/phase/segmented/im_1Amoeba_mask.tif'), Path('ims_for_report/phase/segmented/view_amoebas.jpg'))
